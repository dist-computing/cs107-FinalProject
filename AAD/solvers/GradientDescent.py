...
def AAD_grad(func, init, gamma, max_iter=10000, precision = 10**-6, progress_step=None):
...
# print(AAD_grad(lambda X: abs(2*X[0]-12+2*X[1]**2),[x,y],0.001,progress_step=1000,max_iter=10000))
# print(AAD_grad(lambda X: abs(2*X[0]-12),[x],0.001,progress_step=1000,max_iter=10000))
# print(AAD_grad(lambda X: abs(cos(X[0])*X[1]-12),[x,y],0.01,progress_step=1000,max_iter=10000))
